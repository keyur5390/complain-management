<?php 
require_once  CFG::$absPath."/".CFG::$libraries."/phpmailer/class.phpmailer.php";
/**
...
function mosMail( $from, $fromname, $recipient, $subject, $body, $mode=0, $cc=NULL, $bcc=NULL, $attachment=NULL, $replyto=NULL, $replytoname=NULL ) {
        ...
        $from='info@datatech.in';
	$mosConfig_absolute_path = CFG::$absPath; 
	$mosConfig_mailfrom = $from;
	$mosConfig_fromname = $fromname;
...
function mosCreateMail( $from='', $fromname='', $subject, $body ) {
	...
	$mosConfig_plugin_path = CFG::$libraries;
	$mosConfig_mailfrom = $from;
	$mosConfig_fromname = $fromname;
	$mosConfig_mailer = "mail";
	...
	$mail->PluginDir = $mosConfig_plugin_path.'/phpmailer/';
	$mail->IsMail();
