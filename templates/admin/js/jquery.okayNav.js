        ...
        init: function() {
            ...
            if (self.options.align_right) {
                self.navigation
                    ...
                    //.append('<a href="#" title="Menu" class="' + self.options.toggle_icon_class + ' okay-invisible">' + self.options.toggle_icon_content + '</a>')
					.append('<a href="#" title="More" class="' + self.options.toggle_icon_class + ' okay-invisible">More</a>')
            } else {
                self.navigation
