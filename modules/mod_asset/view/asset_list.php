        ...
        <div class="container-fluid">
            <div class="row">
                <div class="fullColumn">
                    <div class="topLeft">
                        <div class="pageTitle blc-<?php echo APP::$moduleRecord['icon_class']; ?>"><span>asset List</span></div>
                        <a href="<?php echo URI::getURL(APP::$moduleName, "asset_edit"); ?>" class="trans addNew" title="New asset">New asset</a>
                    </div>
                    <div class="topRight">
                        <div class="dropbox bulkDrop">
                            <select title="Please select actions">
                                <option value="">Actions</option>
                                <option value="" onclick="changeStatus('index.php?m=mod_asset&a=change_status', '', '1')">Active</option>
                                <option value="" onclick="changeStatus('index.php?m=mod_asset&a=change_status', '', '0')">Inactive</option>
                                <option value="" class="hideDeleteOption" onclick="deleteRecord('index.php?m=mod_asset&a=delete_asset', '')">Delete</option>
                            </select>                        	
                        </div>
                        <form id="searchForm">
                            <div class="cust_searchBox searchBox">
                                ...
                                <div class="customeSearch">
                                    <input type="text" id="name" name="searchForm[name]" class="txt" title="Search asset name" placeholder="Search asset name" />
                                </div>
...
<?php } ?>
                                ...
                                <div id="name" class="sorting sort"><span>asset Name</span></div>
    ...
    <div id="noGrid" class="content noRecord hideBlock"> asset records not found </div>
    <div class="mobiAction" style="display:none;">
        <div class="counterDiv">0</div>
        <a href="#" onclick="changeStatus('index.php?m=mod_asset&a=change_status', '', '1')" title="Active" class="activeStatus"></a>
        <a href="#" onclick="changeStatus('index.php?m=mod_asset&a=change_status', '', '0')" title="Inactive" class="inactiveStatus"></a>
        <a href="#" onclick="deleteRecord('index.php?m=mod_asset&a=delete_asset', '')" title="Delete" class="delIcon hideDeleteOption">Delete</a>
