...
//            $("#description").val(pageData['complainData'].description);
            var forward=(pageData['complainData'].forward!=null?pageData['complainData'].forward:0);
            <?php if(isset($_REQUEST['type']) && $_REQUEST['type']=="forward") {?>
            $('#complainId').html(pageData['complainData'].id+"_"+parseInt(forward+1));
            $('#forwardC').val(parseInt(forward+1));
            $("input").attr("disabled","disabled");
            $("select").attr("disabled","disabled");
            $("checkbox").attr("disabled","disabled");
            $("#department").removeAttr("disabled","disabled");
            $("#forwardC").removeAttr("disabled","disabled");
            <?php }?>
...
//            }
//            if(pageData['complainData'].status!=''){
//                 $("#chkStatus").val(pageData['complainData'].status);
//            }
