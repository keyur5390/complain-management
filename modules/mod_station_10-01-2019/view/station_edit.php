                                ...
                                <div class="accDiv tabDiv current" id="tab-1">
                                    <div class="formBox oneCol">
                                        ...
                                        <ul class="row">
                                            ...
                                            <li class="">
                                                <span for="parent_station" class="labelSpan">Description:</span>
                                                <div class="txtBox">
                                                    <textarea id="description" name="description" class="txt "></textarea>
                                                </div>
                                            </li>
                                            <li class="halfLi">
                                                <span for="parent_station" class="labelSpan">Type:</span>
                                                <div class="txtBox">
