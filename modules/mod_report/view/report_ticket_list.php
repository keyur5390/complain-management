            ...
            <div class="row">
                <div class="fullColumn repMain">
                    <div class="topLeft bottomSpace">
                        ...
                        <a href="#" onclick="export_data();" title="Export To CSV" class="trans addNew export_file" >Export To CSV</a>
                    </div> 
                    <!-- rightSide div -->
                    ...
                    <form id="frmGrid">
                        <ul class="table">
                            <li class="topLi">
                                ...
                                <div id="close_date" class="sorting sort"><span>Closing Date</span></div>
                            </li>
                        </ul>
                    </form>                                
                    <div class="tableBtm">
