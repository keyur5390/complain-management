    ...
    //            }
                ...
                {	var region="";
                        ...
                        <?php if(Core::hasAccess(APP::$moduleName, "user_edit")) { ?>
                               list = list + '<a href="index.php?m=mod_inventory&a=inventory_list&userid=' + data.records[i].id + '"  title="' + data.records[i].name + '">' + data.records[i].name + '</a>';
                       <?php } else { ?>
            ...
            validateSearchForm = function()
            {
                if ($("#user_name").val() == "")
                {
                    if ($("#searchByRole").val() == "") 
                    {
                        alert("Please select region or enter name, username, email or phone for search");
                        return false;
                    } 
                    else 
                    {
