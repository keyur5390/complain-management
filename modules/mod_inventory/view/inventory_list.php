...
defined('DMCCMS') or die('Unauthorized access');
 $cname = UserModel::getCustomerName($_GET['userid']);
?>
<script>
...
<section>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="fullColumn">
                    <div class="topLeft">
                        <div class="pageTitle blc-<?php echo APP::$moduleRecord['icon_class']; ?>"><span>Inventory List</span></div>
                        
                        <a href="<?php echo URI::getURL(APP::$moduleName,"user_list");?>" class="trans comBtn import_file" title="Back to list" style="height:35px!important;     line-height: 36px;
    clear: left;
    vertical-align: middle;">Back to list</a>
                        <a href="<?php echo URI::getURL(APP::$moduleName,"inventory_edit");?>&userid=<?php echo $_GET['userid']; ?>" class="trans addNew" title="New Inventory">New Inventory</a>
                    </div>
                    &nbsp;
                    <?php
                    /*
                    ...
                    <a href="javascript:;" onclick="csvImport('<?php echo $_GET['userid'];?>');" class="trans addNew import_file" title="Import CSV">Import CSV</a>
                     <?php } ?>
                    ...
                    <div class="topRight">
                        ...
                        <div class="CUTName"><span>Customer Name:</span> <?php echo $cname; ?></div>
                    ...
                    <form id="frmGrid">
                        <ul class="table">
                            <li class="topLi">
                                ...
                                <div id="product_sr_no" class="sorting sort"><span>Product Sr. No</span></div>
                                ...
                                <div id="product_name" class="sorting sort"><span>Model Name</span></div>
                                 <div id="warranty_start_date" class="sorting sort"><span>Warranty Start Date</span></div>
    ...
    <div id="noGrid" class="content noRecord hideBlock"> Inventory records not found </div>
