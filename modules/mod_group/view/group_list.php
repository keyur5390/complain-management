<?php
//restrict direct access to the types of group
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="fullColumn">
                    <div class="topLeft">
                        <div class="pageTitle blc-<?php echo APP::$moduleRecord['icon_class']; ?>"><span>Group List</span></div>
...
<!--                                        <option value="" onclick="changeStatus('index.php?m=mod_group&a=change_status', '', '1')">Active</option>
                                        <option value="" onclick="changeStatus('index.php?m=mod_group&a=change_status', '', '0')">Inactive</option>-->
                                        <option value="" onclick="deleteRecord('index.php?m=mod_group&a=delete_group', '')">Delete</option>
                                    </select>                        	
                                </div>
                        ...
                        <form id="searchForm">
                            <div class="cust_searchBox searchBox">
                                ...
                                <div class="customeSearch" style="margin-left: 15px;width: 220px">
                                    <input type="text" id="name" name="searchForm[name]" class="txt" title="Search group name" placeholder="Search group name" />
                                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="fullColumn proList">
                   ...
                   <form id="groupForm">
                   	<span class="proText">
                  		<input type="text" id="txtgroup" name="txtgroup" class="txt" title="Group Name" placeholder="Group name"/>
                  	</span>
                  <input type="hidden" id="txtid" name="txtid"/>
                  <span class="protypeBtn">
                    <input type="submit" class="btn cust_searchBox" title="Add/Update group" name="btnsub" value="Add Type of group" id="btnsub" />
                  </span>
                    ...
                    <form id="frmGrid">
                        <ul class="table">
                            ...
                            <?php }?>
                                ...
                                <div id="name" class="sorting sort"><span>Group Name</span></div>
...
<!--                                    <option value="" onclick="changeStatus('index.php?m=mod_group&a=change_status', '', '1')">Active</option>
    ...
    <div id="noGrid" class="content noRecord hideBlock"> Groups records not found </div>
    <div class="mobiAction" style="display:none;">
        <div class="counterDiv">0</div>
       
<!--        <a href="#" onclick="changeStatus('index.php?m=mod_group&a=change_status', '', '1')" title="Active" class="activeStatus"></a>
        <a href="#" onclick="changeStatus('index.php?m=mod_group&a=change_status', '', '0')" title="Inactive" class="inactiveStatus"></a>-->
        <a href="#" onclick="deleteRecord('index.php?m=mod_group&a=delete_group', '')" title="Delete" class="delIcon hideDeleteOption">Delete</a>
