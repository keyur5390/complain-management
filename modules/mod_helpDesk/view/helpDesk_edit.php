        ...
        <div class="container-fluid">
            <div class="row">
                <div class="fullColumn">
                    <div class="topLeft">
                        <div class="pageTitle blc-<?php echo APP::$moduleRecord['icon_class']; ?>"><span><?php echo isset(APP::$curId) && !empty(APP::$curId) ? "Update" : "Add/Edit" ?> Help Desk</span></div>
                    </div>
                    <div class="topRight btnRight">
                        <ul class="btnUl threeBtn">    
                            <li><a href="<?php echo URI::getURL(APP::$moduleName,"helpDesk_list");?>" class="trans comBtn backBtn" title="Back to list">Back to list</a></li>
                ...
                <div class="fullColumn">
                    <div class="midWhite">
                        <div class="tabBox">
                            ...
                            <form class="form-horizontal" id="frmHelpDesk" method="post">
                            <div class="tabMain">
                                ...
                                <div class="accDiv tabDiv current" id="tab-1">
                                    <div class="formBox oneCol">
                                        ...
                                        <ul class="row">
                                            <li class="halfLi">
                                                <span for="name" class="labelSpan star">Help Desk Name:</span>
                                                <div class="txtBox">
                                                    <input type="text" name="name" id="name" class="txt required" maxlength="100" title="Help Desk Name" >    
                                                    <small>Maximum character length 100</small>
                                                </div>
                                            </li>
                                            <li class="halfLi">
                                                <span for="code" class="labelSpan">Help Desk Code:</span>
                                                <div class="txtBox">
                                                    <input type="text" name="code" id="code" class="txt required" maxlength="50" title="Help Desk Code" >
                                                    <small style="position: static;">Enter Unique Help Desk Code</small><small>Maximum character length 50</small>
                                                </div>
                                            ...
                                            <li class="halfLi">
                                                <span for="manager" class="labelSpan star">Help Desk Manager (User):</span>
                                                <div class="txtBox">
                                                    <select name="manager[]" id="manager" title="Help Desk" multiple="true" class="progControlSelect2 required">
                                                    </select> 
                                                </div>
                                            </li>
                                            
                                            <li class="halfLi">
                                                <span for="region" class="labelSpan">Region:</span>
                                                <div class="txtBox">
                                                    <!--<input type="hidden" id="actionName" value="helpDesk_edit" >-->
                                                    <select name="region[]" id="region" title="Region" multiple="true" class="progControlSelect2_1"> 
                                                    </select> 
                                                </div>
                                            </li>
