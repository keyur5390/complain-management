...
//     print_r($data); exit;
    ...
    <ul class="navUl" id="nav-bar-filter" aria-labelledby="menulist">
       <li><a href="#" title="Compalinname"> <span class="iconSpan"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/attribute.png" class="fiImg"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/attribute-active.png" class="secImg"></span>Configuration Manager</a><ul start="" class="sub "> 
        <li><a href="<?php echo CFG::$livePath;?>/index.php?m=mod_station&a=station_list" title="Station"> 
                <span class="iconSpan"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/attribute.png" class="fiImg"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/attribute-active.png" class="secImg"></span>Station</a></li>
        <li class="active"><a href="<?php echo CFG::$livePath;?>/index.php?m=mod_employee&a=employee_list" title="Employee" class="active"> <span class="iconSpan"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/attribute.png" class="fiImg"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/attribute-active.png" class="secImg"></span>Employee</a></li>
        
        <li><a href="<?php echo CFG::$livePath;?>/index.php?m=mod_asset&a=asset_list" title="Asset"> <span class="iconSpan"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/attribute.png" class="fiImg"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/attribute-active.png" class="secImg"></span>Asset</a></li>
        
        <li><a href="<?php echo CFG::$livePath;?>/index.php?m=mod_department&a=department_list" title="Department Name"><span class="iconSpan"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/repair-department_list.png" class="fiImg"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/repair-department_list-active.png" class="secImg"></span>Department Name</a></li>
        <li><a href="<?php echo CFG::$livePath;?>/index.php?m=mod_group&a=group_list" title="Group Management"> <span class="iconSpan"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/.png" class="fiImg"><img src="h<?php echo CFG::$livePath;?>/templates/admin/images/-active.png" class="secImg"></span>Group Management</a></li>
        <li><a href="<?php echo CFG::$livePath;?>/index.php?m=mod_equipment&a=equipment_list" title="Equipment Management"> <span class="iconSpan"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/.png" class="fiImg"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/-active.png" class="secImg"></span>Equipment Management</a></li>
        <li><a href="<?php echo CFG::$livePath;?>/index.php?m=mod_compalinname&a=compalinname_list" title="Compalin Name"><span class="iconSpan"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/attribute-compalinname_list.png" class="fiImg"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/attribute-compalinname_list-active.png" class="secImg"></span>Compalin Name</a></li></ul></li>
        <li><a href="<?php echo CFG::$livePath;?>/index.php?m=mod_user&a=user_list" title="Users"> <span class="iconSpan"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/enquiry.png" class="fiImg"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/enquiry-active.png" class="secImg"></span>Users</a></li>
        <li><a href="<?php echo CFG::$livePath;?>/index.php?m=mod_complain&a=complain_list" title="Complain"> <span class="iconSpan"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/attribute.png" class="fiImg"><img src="<?php echo CFG::$livePath;?>/templates/admin/images/attribute-active.png" class="secImg"></span>Complain</a></li>
