                    ...
                    <div class="topRight ticSearchBar">
                         ...
                         <form id="searchForm" class="ticketForm">
                            ...
                            <div class="cust_searchBox searchBox ipadFull">
                                  <?php /* <div class="" id="allRegLi" >	
                                                    <span class="labelSpan">Unassigned Engineer:</span>
                                                    <div class="optionBox">
                                                        <div class="chkInn">
                                                            <label>
                                                                <input type="checkbox" class="checkbox">
                                                                <input type="checkbox" class="checkbox" id="chkEng" name="chkEng" value="0" title="EngStatus" data-content="EngStatus">
                                                                <span></span>
                                                            </label>
                                                            <label for="RegStatus" id="checkEng"></label>
                                                        </div>                                                   
                                                    </div>
                                                </div>    */ ?> 
                                <div class="customeSearch">
                                    ...
                                    <div class="dropbox " style="width:100%">
                                        <select title="Please select status" id="searchByStatus" name="searchForm[status]"  >
                                            ...
                                            <?php
                                               ...
                                               <? }
                                                ?>
                                                    <option value="unassignedEng">Unassigned Engineer</option>
                                        </select>                        	
                                    </div>
                                </div>
                                <div class="customeSearch">
...
<!--                            <div class="dropbox bulkDrop">
    ...
    <div class="mobiAction" style="display:none;">
        ...
        <?php if(Core::hasAccess(APP::$moduleName, "delete_ticket")) { ?>
        <option value="" class="hideDeleteOption" onclick="deleteRecord('index.php?m=mod_ticket&a=delete_ticket', '')">Delete</option>
        <?php }?>
