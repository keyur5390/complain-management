        ...
        <div class="container-fluid">
            <div class="row">
                <div class="fullColumn">
                    <div class="topLeft">
                        <div class="pageTitle blc-<?php echo APP::$moduleRecord['icon_class']; ?>"><span><?php echo isset(APP::$curId) && !empty(APP::$curId) ? "Update" : "Add/Edit" ?>Station</span></div>
                    </div>
                    <div class="topRight btnRight">
                        <ul class="btnUl threeBtn">    
                            <li><a href="<?php echo URI::getURL(APP::$moduleName,"station_list");?>" class="trans comBtn backBtn" title="Back to list">Back to list</a></li>
                ...
                <div class="fullColumn">
                    <div class="midWhite">
                        <div class="tabBox">
                            ...
                            <form class="form-horizontal" id="frmstation" method="post">
                            <div class="tabMain">
                                    ...
                                    <div class="formBox oneCol">
                                        ...
                                        <ul class="row">
                                            ...
                                            <li class="halfLi">
                                                ...
                                                <div class="txtBox">
                                                    <input type="text" name="name" id="name" maxlength="100" class="txt required" title="station Name" >
                                                    <small>Maximum character length 100</small>
                                                </div>
                                            </li>
                                            <li class="halfLi">
                                                <span for="code" class="labelSpan">Station Code:</span>
                                            ...
                                            <li class="halfLi">
                                                <span for="parent_station" class="labelSpan">Type Of Equipment:</span>
                                                <div class="txtBox">
                                                    <?php if(isset($data['stationData']['equipment'])){
                                                        $seleEquipment= explode(",",$data['stationData']['equipment']);
                                                    }
//                                                    print_r($data);
?>
                                                    <!--<input type="text" name="equipment" id="equipment" class="txt required" maxlength="50" title="Type Of Equipment" >-->
                                                    <select id="equipment" multiple="" style="height: 100px;" name="equipment[]">
                                                        <option value="0">Select Type</option>
                                                        <?php foreach($data['equipmentdata'] as  $key=>$val){?>
                                                             <option value="<?php echo  $val['id'];?>" <?php echo (isset($data['stationData']['equipment']) && in_array($val['id'], $seleEquipment)?"selected='selected'":"");?>><?php echo $val['name'];?></option>
                                                        <?php }?>
                                                    </select> 
                                                </div>
                                            </li>
...
<?php // include CFG::$absPath . '/' . CFG::$helper . "/templates/add_new_parent_station.php"; ?>