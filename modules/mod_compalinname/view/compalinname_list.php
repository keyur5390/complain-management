        ...
        <div class="container-fluid">
            <div class="row">
                <div class="fullColumn">
                    <div class="topLeft">
                        <div class="pageTitle blc-<?php echo APP::$moduleRecord['icon_class']; ?>"><span>Complain Name List</span></div>
                        <a href="<?php echo URI::getURL(APP::$moduleName, "compalinname_edit"); ?>" class="trans addNew" title="New compalinname">New Complain Name</a>
                    </div>
                    <div class="topRight">
                        <div class="dropbox bulkDrop">
                            <select title="Please select actions">
                                <option value="">Actions</option>
                                <option value="" onclick="changeStatus('index.php?m=mod_compalinname&a=change_status', '', '1')">Active</option>
                                <option value="" onclick="changeStatus('index.php?m=mod_compalinname&a=change_status', '', '0')">Inactive</option>
                                <option value="" class="hideDeleteOption" onclick="deleteRecord('index.php?m=mod_compalinname&a=delete_compalinname', '')">Delete</option>
                            </select>                        	
                        </div>
                        <form id="searchForm">
                            <div class="cust_searchBox searchBox">
                                ...
                                <div class="customeSearch">
                                    <input type="text" id="name" name="searchForm[name]" class="txt" title="Search Complain Name name" placeholder="Search Complain Name name" />
                                </div>
...
<?php } ?>
    ...
    <div id="noGrid" class="content noRecord hideBlock"> Complain Name records not found </div>
    <div class="mobiAction" style="display:none;">
        <div class="counterDiv">0</div>
        <a href="#" onclick="changeStatus('index.php?m=mod_compalinname&a=change_status', '', '1')" title="Active" class="activeStatus"></a>
        <a href="#" onclick="changeStatus('index.php?m=mod_compalinname&a=change_status', '', '0')" title="Inactive" class="inactiveStatus"></a>
        <a href="#" onclick="deleteRecord('index.php?m=mod_compalinname&a=delete_compalinname', '')" title="Delete" class="delIcon hideDeleteOption">Delete</a>
